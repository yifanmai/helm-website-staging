...
$(function () {
  ...
  // Extract the name of the release/suite from the URL parameters. Default to "v0.2.4" if none is specified.
  if (usingRelease) {
    version = "release" in urlParams ? urlParams.release : "v0.2.4";
  } else {
    version = "suite" in urlParams ? urlParams.suite : "v0.2.4";
  }
